const logout = () => {
    ...
    $(document).ready(function () {
        ...
        var expired_Check = document.getElementById('expired_Check');
        expired_Check.addEventListener('change', function (e) {
            e.preventDefault();
        ...
        var lowStock_Check = document.getElementById('lowStock_Check');
        lowStock_Check.addEventListener('change', function (e) {
            e.preventDefault();
            let tablebody = document.getElementById('table-body');
            let tr = tablebody.getElementsByTagName('tr');
            for (let i = 0; i < tr.length; i++) {
